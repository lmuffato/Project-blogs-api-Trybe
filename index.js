...
app.get('/categories', AuthUser, CategoryController.listCategories);
app.post('/post', AuthUser, BlogPostController.createPost);
app.get('/post', AuthUser, BlogPostController.listPosts);
